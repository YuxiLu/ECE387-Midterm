...
//LCD pins			PORT, PIN
#define LCD_D4		B, 2 // Arduino 10
#define LCD_D5		B, 1 // Arduino 9
#define LCD_D6		B, 0 // Arduino 8
#define LCD_D7		D, 7 // Arduino 7
#define LCD_RS		B, 5 // Arduino 13
#define LCD_RW		B, 3 // Arduino 11
#define LCD_EN		B, 4 // Arduino 12
//----------------------------------------------//
#endif
